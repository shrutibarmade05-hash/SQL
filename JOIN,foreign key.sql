...
select orders.order_date , product.product_name , customer.customer_name , customer.customer_id from customer LEFT  JOIN  orders on customer.order_id  = orders .order_id  LEFT JOIN product on customer.product_id = product.product_id;

select orders.order_date , product.product_name , customer.customer_name , customer.customer_id from customer INNER  JOIN  orders on customer.order_id  = orders .order_id  INNER JOIN product on customer.product_id = product.product_id;

select orders.order_date , product.product_name , customer.customer_name , customer.customer_id from customer RIGHT  JOIN  orders on customer.order_id  = orders .order_id  RIGHT JOIN product on customer.product_id = product.product_id;
